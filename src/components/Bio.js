...
const Bio = ({deviceClass}) => {
    ...
    return (
        <div className="reset-padding medium-padding-bottom prevent-select ${deviceClass}">
            ...
            <h4 className='small-margin-bottom'>I'm a first-class graduate of Software Engineering, in London,
            ...
            <h4 className='small-padding-bottom small-padding-top small-margin-bottom'>I recently gained two years of experience in management, exploring my capabilities running large teams under pressure. I managed a team of 15 staff; focusing on consistent delivery, working standards and skills coaching. Previously, I helped large and small companies transform their data analysis.</h4>
            <h4 className="bio-blog-link small-margin-bottom">
